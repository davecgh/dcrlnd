...
func receiverHtlcSpendTimeout(signer Signer, signDesc *SignDescriptor,
	sweepTx *wire.MsgTx, cltvExpiry uint32) (TxWitness, error) {
...
func createHtlcTimeoutTx(htlcOutput wire.OutPoint, htlcAmt dcrutil.Amount,
	...
	pkScript, err := witnessScriptHash(witnessScript) // TODO(davec): witnessScriptHash -> p2sh
	if err != nil {
		return nil, err
	}
...
func DeriveRevocationRoot(derivationRoot *secp256k1.PrivateKey,
	blockSalt chainhash.Hash, nodePubKey *secp256k1.PublicKey) chainhash.Hash {
