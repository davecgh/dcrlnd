...
import (
	...
	//"github.com/decred/dcrwallet/chain" // TODO(davec): Uncomment
...
//
// This is a part of the WalletController interface.
func (b *DcrWallet) ConfirmedBalance(confs int32, witness bool) (dcrutil.Amount, error) {
...
//
// This is a part of the WalletController interface.
func (b *DcrWallet) GetPrivKey(a dcrutil.Address) (*secp256k1.PrivateKey, error) {
...
//
// This is a part of the WalletController interface.
func (b *DcrWallet) NewRawKey() (*secp256k1.PublicKey, error) {
...
//
// This is a part of the WalletController interface.
func (b *DcrWallet) FetchRootKey() (*secp256k1.PrivateKey, error) {
	...
	rootAddr, err := dcrutil.NewAddressWitnessPubKeyHash(rootAddrHash,
		b.netParams)
	if err != nil {
		return nil, err
	}
...
func (b *DcrWallet) SendOutputs(outputs []*wire.TxOut,
	feeSatPerByte dcrutil.Amount) (*chainhash.Hash, error) {
...
//
// This is a part of the WalletController interface.
func (b *DcrWallet) ListUnspentWitness(minConfs int32) ([]*lnwallet.Utxo, error) {
	...
	for _, output := range unspentOutputs {
		...
		if addressType == lnwallet.WitnessPubKey ||
			...
			utxo := &lnwallet.Utxo{
				...
				Value:       dcrutil.Amount(output.Amount * 1e8),
				PkScript:    pkScript,
...
//
// This is a part of the WalletController interface.
func (b *DcrWallet) IsSynced() (bool, error) {
